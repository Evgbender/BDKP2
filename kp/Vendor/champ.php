...
<div class="listPlot">
    ...
    foreach ($games as $game){
        ?>
        <p class="ucRows1"><span style="display: inline-block"><?=$game[0] ?></span></p><p style="display: inline-block;float: right; position: absolute; right: 25%; padding: 2% 0; width: 40%; font-family: Bahnschrift;font-size: medium"><span style="display: inline-block"><?=$game[1] ?></span><span style="display: inline-block; float: right"><?=$game[2] ?></span></p>
