...
<html>
    ...
    <?php if($_SESSION['rl']<3) {?>
        <script>
            document.getElementById('ageBt').style.visibility = 'visible';
            document.getElementById('emailBt').style.visibility = 'visible';
            document.getElementById('rankBt').style.visibility = 'visible';
            document.getElementById('winBt').style.visibility = 'visible';
            document.getElementById('losBt').style.visibility = 'visible';
        </script>
    <?php };?>
